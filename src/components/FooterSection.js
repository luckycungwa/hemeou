      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-10 md:px-12 lg:px-5 space-y-5">
        <div className="py-3 border-t border-t-gray-100 dark:border-t-gray-900 flex flex-col md:flex-row md:justify-between gap-6 md:items-center">
          ...
          <div className="flex-1 max-w-md">
            <form action="#" className="w-full flex flex-col sm:flex-row gap-3" onSubmit={(e) => e.preventDefault()}>
              <input
                type="email"
                placeholder="johndoe@gmail.com"
                className="px-5 py-2.5 rounded-md outline-none flex-1 bg-gray-200 dark:bg-gray-800"
              />
              <button className="outline-none w-full py-2.5 px-5 sm:w-max bg-blue-600 text-white rounded-md flex items-center justify-center" onClick={() => console.log("clicked")}>
                Subscribe
              </button>
            </form>
          </div>
        ...
        <div className="px-5 sm:px-10 md:px-12 lg:px-5 flex justify-center text-center py-3 bg-gray-100 dark:bg-gray-900 rounded-md">
          <p> &copy; {new Date().getFullYear()} Hemeou . All Rights Reserved</p>
        </div>
      </div>
    </footer>
  );
